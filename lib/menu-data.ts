...
export const MOCK_MENU: MenuItem[] = [
  ...
  // Combo Category (New)
  {
    ...
    category: 'Combo',
    price: 10.90,
    description: '1x Ayam Gunting XXXL, 1x Chicken Popcorn, 1x Crispy Enoki, 1x Sauce',
    isAvailable: true,
    modifierGroupIds: [],
  },
  {
    ...
    category: 'Combo',
    price: 4.90,
    description: '1x Chicken Wrap, 1x Crispy Enoki, 1x Sauce',
    isAvailable: true,
    modifierGroupIds: [],
  },
  {
    ...
    category: 'Combo',
    price: 10.90,
    description: '1x Chicken Tender XL (3 pcs), 1x Crispy Enoki, 1x Chicken Popcorn, 1x Sauce',
    isAvailable: true,
    modifierGroupIds: [],
  },
  {
    ...
    category: 'Combo',
    price: 5.00,
    description: '1x Chicken Popcorn, 1x Crispy Chicken Skin, 1x Sauce',
    isAvailable: true,
    modifierGroupIds: [],
  },
  {
    ...
    category: 'Combo',
    price: 11.00,
    description: '1x Burger Crispy XXL, 1x Potato Bowl, 1x Sauce',
    isAvailable: true,
    modifierGroupIds: [],
  },
  {
    ...
    category: 'Combo',
    price: 5.90,
    description: '1x Potato Bowl, 1x Chicken Popcorn',
    isAvailable: true,
    modifierGroupIds: [],
  },
  {
    ...
    category: 'Combo',
    price: 14.00,
    description: '1x Nashville Mozzarella Cheese (3 pcs), 1x Chicken Popcorn, 1x Sauce',
    isAvailable: true,
    modifierGroupIds: [],
  },
  ...
  // Party Sets Category (New)
  {
    ...
    category: 'Party Sets',
    price: 49.90,
    description: '3x Ayam Gunting XXXL, 2x Burger Crispy XXL, 2x Potato Bowl, 3x Crispy Enoki',
    isAvailable: true,
    modifierGroupIds: [],
  },
  {
    ...
    category: 'Party Sets',
    price: 99.90,
    description: '5x Burger Crispy XXL, 5x Ayam Gunting XXXL, 5x Chicken Tender XL (3pcs), 3x Crispy Chicken Wrap, 3x Potato Bowl, 2x Pepsi (1.5L Bottle)',
    isAvailable: true,
    modifierGroupIds: [],
  },
  {
    ...
    category: 'Party Sets',
    price: 149.90,
    description: '7x Ayam Gunting XXXL, 5x Burger Crispy XXL, 4x Chicken Popcorn, 4x Crispy Enoki, 3x Nashville Mozzarella Cheese (3pcs), 3x Chicken Tender XL (6pcs), 3x Pepsi (1.5L Bottle)',
    isAvailable: true,
    modifierGroupIds: [],
  },
];
