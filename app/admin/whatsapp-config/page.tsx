        ...
        <MainLayout>
            <div className="max-w-5xl mx-auto p-6 space-y-6 animate-fade-in">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="text-center space-y-6 w-full max-w-sm">
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-inner border border-gray-200 mx-auto w-64 h-64 flex items-center justify-center relative overflow-hidden">
                                    {qrCode && qrCode !== 'available' ? (
                                        ...
                                        <div className="flex flex-col items-center gap-4 text-gray-500 text-center px-4">
                                            <div className="w-12 h-12 border-4 border-yellow-400 border-t-transparent rounded-full animate-spin"></div>
                                            <div>
                                                <p className="font-bold text-gray-800 dark:text-gray-200">Menunggu QR...</p>
                                                <p className="text-xs mt-1">
                                                    Server signal: "available".<br />
                                                    Jika lama, sila check <b>Railway Logs</b> server untuk QR code.
                                                </p>
                                            </div>
                                        </div>
                                    ) : (
                    ...
                    {/* Debug Info */}
                    <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg text-xs font-mono overflow-auto">
                        <p className="font-bold mb-2">Debug Info:</p>
                        <p>Status: {status}</p>
                        <p>QR Raw: {qrCode || 'null'}</p>
