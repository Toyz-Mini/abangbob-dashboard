...
export default function StaffKPIProfilePage() {
    ...
    // Wait for hydration/params
    if (!staffId) {
        // Ideally redirect or show error, but return null during static render
        // We can return a loading state or "No ID provided"
        return (
            <MainLayout>
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '50vh' }}>
                    <p>No staff ID provided.</p>
                </div>
            </MainLayout>
        );
    }
    ...
    // const totalTrainingCount = staffTraining.length; // Unused
